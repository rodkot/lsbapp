package ru.nsu.ccfit.lsbapp.windows
...
import ru.nsu.ccfit.lsbapp.component.*
import ru.nsu.ccfit.lsbapp.dialog.impl.AboutDialog
import ru.nsu.ccfit.lsbapp.dialog.impl.FileOpenDialog
import ru.nsu.ccfit.lsbapp.dialog.impl.FileSaveDialog
import ru.nsu.ccfit.lsbapp.dialog.impl.ManualDialog
...
class MainWindow : Renderable {
    ...
    private val currentFilter = mutableStateOf<Filter>(LsbEncodeFilter)
        ...
        Column(
            ...
            Box(Modifier.fillMaxSize().background(Color.Gray)
                ...
                VerticalScrollbar(
                    ...
                    style = ru.nsu.ccfit.lsbapp.component.defaultScrollbarStyle()
                )
                HorizontalScrollbar(

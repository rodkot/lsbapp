package ru.nsu.ccfit.lsbapp.dialog.impl
...
fun AboutDialog(cancelClick: () -> Unit) {
    ...
    AlertDialog(
        ...
        title = { Text(text = "О программе LsbApp") },
        modifier = Modifier.width(300.dp),
        text = {
            Column {
                Text(text = "Разработчик:")
                Text(text = "Котов Родион", textAlign = TextAlign.Center, modifier = Modifier.fillMaxWidth())
                Text(text = "студент 4 курса ФИТ НГУ", textAlign = TextAlign.Center, modifier = Modifier.fillMaxWidth())
                Spacer(Modifier.width(20.dp))
                Text(text = "Программа созадана в рамках курса \"Защита информации\" ", textAlign = TextAlign.Center)
                Spacer(Modifier.width(20.dp))
